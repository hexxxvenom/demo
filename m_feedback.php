<?php
	...
	if(isset($_POST['send']))
	{
		...
		$qry_insert=mysqli_query($con,"INSERT INTO `m_feedback`(`f_id`, `name`, `email`, `subject`, `msg`) VALUES ('','$name','$email','$subject','$msg')");
		if ($qry_insert) 
		{
			echo "<script>
				alert('Thank you ".$name." for writing the feedback.');
			    window.location='m_feedback.php';
			</script>";
		}
		else
		{
...
<div style="padding: 50px 20px">
    ...
    <form action="#" method="post">
    	<div class="gaps">
        	<p>NAME</p>  
       		<input type="text" name="name" pattern="[a-z A-Z]+" title="Only Letters" required="" style="">  
        </div>
      	<div class="gaps">
        	<p>EMAIL</p>  
